                  ...
                  <div
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{user.inrBalance ?? "—"}</p>
                      </div>
                    </div>
                    <div className="flex gap-2 pt-2 border-t border-border">
                      <Link
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Enter the amount you have paid to this user.
            </p>
          </DialogHeader>
          ...
          <DialogFooter className="mt-4">
            ...
            <Button
              disabled={!payAmount || Number(payAmount) <= 0 || actionLoading}
              onClick={async () => {
                setActionLoading(true);
                try {
                  const res = await fetch(`/api/admin/users/${userId}/pay`, {
                    method: "POST",
                  ...
                  if (!resw.ok) throw new Error("Failed to fetch users");
